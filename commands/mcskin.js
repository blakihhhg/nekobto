  ...
  MojangAPI.nameHistory(`${shortuuid}`, function(err, res) {
    ...
    let mchead = (`https://crafatar.com/renders/head/${shortuuid}?size=4&default=MHF_Steve&overlay`)
     ...
     if (!lastName)
      ...
      .addField(`<:Minecraftlogo:556778621633822720> If U can't see your skin pls click show Skin`, `➡ [Show Skin](https://crafatar.com/renders/body/${longuuid}?size=4&default=MHF_Steve&overlay) ➡  [Download Skin](https://minotar.net/download/${longuuid})`)
...
exports.help = {
    name: "mcskin",
    description: "search for Minecraft skin",
    usage: "mcskin"
}